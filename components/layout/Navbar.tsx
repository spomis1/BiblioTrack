    ...
    <header className="sticky top-0 z-50 w-full border-b border-zinc-200 bg-white/80 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-900/80">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="hidden sm:flex items-center gap-6 text-sm font-medium text-zinc-600 dark:text-zinc-400">
          <Link href="/books" className="hover:text-zinc-900 dark:hover:text-white transition-colors">
            Explorar
          </Link>
          <Link href="/genres" className="hover:text-zinc-900 dark:hover:text-white transition-colors">
            Géneros
          </Link>
          <Link href="/authors" className="hover:text-zinc-900 dark:hover:text-white transition-colors">
            Autores
          </Link>
        </div>
